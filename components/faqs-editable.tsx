...
type FAQsProps = Partial<FAQsBlock> & {
  blockType?: string;
  id?: string;
};
...
export const FAQs = (props: FAQsProps = {}) => {
  const {
    ...
    subheading = "Find all your doubts and questions in one place. Still couldn't find what you're looking for?",
    buttonText1 = "Read Docs",
