...
// Type pour les props (venant de Payload)
type HeroProps = Partial<HeroBlock> & {
  blockType?: string;
  id?: string;
};

export const Hero = (props: HeroProps = {}) => {
  // Valeurs par défaut si pas de données Payload
  const {
    badge = "For Financial Services Leaders",
    primaryHeading = "Understand how you lose clients on ChatGPT",
    subheading = "Optimize your presence where 57% of consumers search before buying.",
    ctaText = "Book a Demo",
    statTitle = "20%+ of traffic now comes from ChatGPT for leading financial services companies",
    statSubtext = "Growing at 10% month-over-month",
  } = props;
...
// Le reste du composant AnimatedChat reste identique
