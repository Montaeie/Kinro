  ...
  const tabs = [
    {
      ...
      description:
        "We deep-dive into your products, current clients, and growth goals to align our analysis with what matters most",
      icon: FirstIcon,
      id: "understand",
    ...
    },
    {
      ...
      description:
        "We gather real ChatGPT conversations aligned with your ideal customer profile and strategic objectives",
      icon: SecondIcon,
      id: "collect",
      skeleton: <ConnectYourTooklsSkeleton />,
    },
    {
      title: "Setup Agent Tracking",
      description:
        "Minimal setup to correctly understand how LLMs visit your website. UTM tracking is just the tip of the iceberg",
      icon: ThirdIcon,
      id: "tracking",
      skeleton: <DeployAndScaleSkeleton />,
    },
    {
      title: "Deliver High-Quality Insights",
      description:
        "Understand where and why you're currently losing clients. Get a concrete action plan including content strategy, partner collaboration, and AI readiness analysis",
      icon: FourthIcon,
      id: "insights",
    ...
    },
    {
      ...
      description:
        "We help you prioritize new product launches and understand your market through comprehensive user behavior analysis",
      icon: FifthIcon,
      id: "growth",
  ...
  return (
    <Container className="border-divide border-x">
      <div className="flex flex-col items-center pt-16">
        ...
        <SectionHeading className="mt-4">Our Methodology</SectionHeading>

        <SubHeading as="p" className="mx-auto mt-6 max-w-2xl">
          From understanding your business to delivering actionable insights, we
          guide you through every step of optimizing your LLM presence
        </SubHeading>
        {/* Desktop Tabs */}
        <div className="border-divide divide-divide mt-16 hidden w-full grid-cols-2 divide-x border-t lg:grid">
          ...
          <div className="relative flex h-full min-h-[450px] items-center overflow-hidden bg-[radial-gradient(var(--color-dots)_1px,transparent_1px)] mask-r-from-90% mask-l-from-90% mask-radial-from-20% [background-size:10px_10px]">
...
export const FourthIcon = (props: React.SVGProps<SVGSVGElement>) => {
  return (
    ...
    >
      <path
        d="M2 11.8333L5.33333 8.5L7.33333 10.5L14 3.83334"
        stroke="currentColor"
        strokeWidth="1.33333"
        strokeLinecap="round"
        strokeLinejoin="round"
      ...
      />
      <path
        d="M6.66667 14.5H2.66667C2.48986 14.5 2.32029 14.4298 2.19526 14.3047C2.07024 14.1797 2 14.0101 2 13.8333V12.5"
        stroke="currentColor"
        strokeWidth="1.33333"
        strokeLinecap="round"
        strokeLinejoin="round"
...
export const FifthIcon = (props: React.SVGProps<SVGSVGElement>) => {
  return (
    <svg
      width="16"
      height="17"
    ...
    >
      <path
        d="M8 2.5L9.06 6.56L10.12 10.62L8 13.8333L5.88 10.62L6.94 6.56L8 2.5Z"
        stroke="currentColor"
        strokeWidth="1.33333"
        strokeLinecap="round"
        strokeLinejoin="round"
      ...
      />
      <path
        d="M3.33325 8.5H2.66659C2.48977 8.5 2.3202 8.42976 2.19518 8.30474C2.07016 8.17971 1.99992 8.01015 1.99992 7.83333V7.16667C1.99992 6.98985 2.07016 6.82029 2.19518 6.69526C2.3202 6.57024 2.48977 6.5 2.66659 6.5H3.33325"
        stroke="currentColor"
        strokeWidth="1.33333"
        strokeLinecap="round"
        strokeLinejoin="round"
      />
      <path
        d="M12.6667 8.5H13.3333C13.5102 8.5 13.6797 8.42976 13.8047 8.30474C13.9298 8.17971 14 8.01015 14 7.83333V7.16667C14 6.98985 13.9298 6.82029 13.8047 6.69526C13.6797 6.57024 13.5102 6.5 13.3333 6.5H12.6667"
        stroke="currentColor"
        strokeWidth="1.33333"
        strokeLinecap="round"
        strokeLinejoin="round"
