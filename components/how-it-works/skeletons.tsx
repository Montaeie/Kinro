...
export const ConnectYourTooklsSkeleton = () => {
  const text = `What's the best home insurance for a salon owner in Denver?`;
  ...
  return (
    <div className="flex h-full w-full items-center justify-center">
      ...
      >
        <div className="size-3 rounded-full border-2 border-brand bg-white dark:bg-neutral-800" />
      ...
      >
        ...
        <div className="mt-4 flex items-center justify-between gap-2">
          ...
          <div className="rounded-sm border border-brand bg-brand/10 px-2 py-0.5 text-xs text-brand">
            Tracked
          </div>
        </div>
        <div className="mt-4 flex items-center justify-between gap-2">
...
export const DeployAndScaleSkeleton = () => {
  ...
  // Define tracking cards data for reusability
  const deployCards = [
    { title: "chatgpt-visit-324", subtitle: "2m ago", branch: "Homepage" },
    {
      title: "chatgpt-visit-128",
      subtitle: "5m ago",
      branch: "Products",
      variant: "success" as const,
    },
    { title: "chatgpt-visit-445", subtitle: "8m ago", branch: "Pricing" },
    {
      title: "chatgpt-visit-223",
      subtitle: "12m ago",
      branch: "About",
      variant: "success" as const,
    },
    {
      title: "chatgpt-visit-891",
      subtitle: "15m ago",
      branch: "Contact",
      variant: "warning" as const,
    },
    {
      title: "chatgpt-visit-337",
      subtitle: "18m ago",
      branch: "Homepage",
      variant: "success" as const,
    },
    {
      title: "chatgpt-visit-556",
      subtitle: "22m ago",
      branch: "Products",
      variant: "danger" as const,
    },
    {
      title: "chatgpt-visit-672",
      subtitle: "25m ago",
      branch: "Pricing",
      variant: "default" as const,
    },
    {
      title: "chatgpt-visit-445",
      subtitle: "28m ago",
      branch: "Homepage",
      variant: "success" as const,
    },
    ...
    >
      ...
      <defs>
        ...
        >
          ...
          <stop stopColor="#06b685" stopOpacity="1" offset="0.5" />
    ...
    >
      ...
      <defs>
        ...
        >
          ...
          <stop stopColor="#06b685" stopOpacity="0.5" offset="0.5" />
          <stop stopColor="#06b685" stopOpacity="0" offset="1" />
        </motion.linearGradient>
      </defs>
    </motion.svg>
  );
  ...
  return (
    <div className="flex h-full w-full items-center justify-center">
      <motion.div
        ...
        transition={{ duration: 0.5 }}
        className="relative w-full max-w-lg rounded-2xl border-t border-gray-300 bg-white p-6 shadow-2xl dark:border-neutral-700 dark:bg-neutral-900"
      >
        {/* Header */}
        <div className="flex items-center justify-between">
          <div className="flex items-center gap-2">
            ...
            <div>
              <h3 className="text-sm font-semibold text-gray-900 dark:text-neutral-100">Market Position</h3>
              <p className="text-xs text-gray-500 dark:text-neutral-400">Real-time insights</p>
            </div>
          </div>
          <motion.div
            initial={{ opacity: 0 }}
        ...
        <DivideX className="my-4" />

        {/* Competitor Bars */}
        <div className="space-y-3">
          {[
            { name: "Your Company", value: 65, color: "bg-brand" },
            { name: "Competitor A", value: 85, color: "bg-red-500" },
            { name: "Competitor B", value: 45, color: "bg-gray-400" },
          ].map((item, index) => (
            <motion.div
              key={item.name}
            ...
            >
              <div className="mb-1 flex items-center justify-between text-xs">
                <span className="font-medium text-gray-700 dark:text-neutral-300">{item.name}</span>
                <span className="text-gray-500 dark:text-neutral-400">{item.value}%</span>
              </div>
        ...
        <div className="space-y-2">
          <h4 className="text-xs font-semibold text-gray-700 dark:text-neutral-300">Action Items</h4>
          {[
      ...
      >
        ...
        <div className="flex items-center justify-between">
          <div className="flex items-center gap-2">
            ...
            <div>
              <h3 className="text-sm font-semibold text-gray-900 dark:text-neutral-100">Growth Strategy</h3>
              <p className="text-xs text-gray-500 dark:text-neutral-400">Product prioritization</p>
            </div>
          </div>
          <motion.div
            initial={{ opacity: 0 }}
        ...
        <div className="space-y-3">
          {[
            { product: "AI Protection", priority: "High", demand: 92 },
            { product: "Cyber Insurance", priority: "High", demand: 88 },
            { product: "Pet Insurance", priority: "Medium", demand: 65 },
            { product: "Auto Insurance", priority: "Low", demand: 45 },
          ].map((item, index) => (
            <motion.div
              key={item.product}
            ...
            >
              <div className="flex-1">
                <div className="text-xs font-medium text-gray-900 dark:text-neutral-100">{item.product}</div>
                <div className="mt-1 text-xs text-gray-500 dark:text-neutral-400">Market demand: {item.demand}%</div>
              </div>
              <motion.div
                initial={{ scale: 0 }}
                animate={{ scale: 1 }}
        ...
        <div className="mt-4 flex h-20 items-end justify-between gap-2">
          {[40, 55, 65, 75, 85].map((height, index) => (
            <motion.div
              key={index}
              initial={{ height: 0 }}
              animate={{ height: `${height}%` }}
              transition={{ duration: 0.8, delay: 0.6 + index * 0.1 }}
              className="flex-1 rounded-t-lg bg-brand/20 dark:bg-brand/30"
            />
          ))}
        </div>
